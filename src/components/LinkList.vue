        ...
        subscribeToMore: [
          {
            ...
            updateQuery: (previous, { subscriptionData }) => {
              // retrieve the new link from the subscription data (subscriptionData.data.Link.node),
              // merge it into the existing list of links and return the result of this operation
